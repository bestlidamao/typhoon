export const PKPNFTAbi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "newResolverAddress", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "newFreeMintSigner", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newMintCost", type: "uint256" }],
    name: "setMintCost",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
